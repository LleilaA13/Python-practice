...
function returns a dictionary in which the keys are the
...
Define a function func2(dict1, a, b) that takes as input a dictionary
that has keys and values of type string and two strings of length
one. The function must return a list consisting of those strings of
the dictionary with a character between the characters a and b, always
ignoring the distinction between upper and lower case.  The returned
list must be sorted by decreasing number of characters and, in case of
a tie, in alphabetical order.

Example:

func2({'Car':'GoOd', 'floor':'bAd', 'Wild':'EXCELLENT', 'air':'Bad',
    'cocoon':'greaT'}, 'c', 'G') must return the list ['greaT',
    'GoOd', 'bAd'] '''
